...
if choice1 == "left":
    choice2 = print("You come to a lake. There is an island in the middle of the lake. ")
    choice2 = input("Type 'wait' to wait for a boat. Type 'swim' to swim across. \n").lower()
    if choice2 == "wait":
        choice3 = print("You arrive at the island unharmed. There is a house with 3 doors. ")
